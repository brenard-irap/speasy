...
__version__ = '1.4.0'
__all__ = ['amda', 'cda', 'ssc', 'csa', 'get_data', 'archive', 'SpeasyVariable', 'Catalog', 'Event', 'Dataset',
           'TimeTable', 'extra']
__docformat__ = "numpy"
...
from .core.requests_scheduling.request_dispatch import get_data, list_providers, amda, cda, csa, ssc, archive, extra
