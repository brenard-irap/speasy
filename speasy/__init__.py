...
__version__ = '1.5.1'
__all__ = ['amda', 'cda', 'ssc', 'csa', 'clweb', 'get_data', 'archive', 'SpeasyVariable', 'Catalog', 'Event',
           'Dataset', 'TimeTable']
__docformat__ = "numpy"
...
from .core.requests_scheduling.request_dispatch import get_data, list_providers, amda, cda, csa, ssc, clweb, archive
